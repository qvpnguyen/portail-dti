...
<html>
    <head>
        <title>Modification d'utilisateur - Portail du département de l'informatique</title>
        <meta charset="UTF-8">
            ...
            <div class="container px-5 d-flex justify-content-center">
                <div class="row">
                    <div class="boite-inscription">
                        ...
                        <form action="modificationUtilisateurController" method="get">
                            ...
                            <div class="row gx-5 mx-2">
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="form-group my-3">
                                        <label>Cet utilisateur est:</label>
                                        <label class="radio-inline" for="active">
                                            <input type="radio" id="active" value="true" name="active">Actif
                                        </label>
                                        <label class="radio-inline" for="desactive">
                                            <input type="radio" id="desactive" value="false" name="active">Inactif
                                        </label>
                                    </div>
                                </div>
                            </div>
