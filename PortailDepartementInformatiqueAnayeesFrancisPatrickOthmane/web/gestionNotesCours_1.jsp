<%@page import="com.portailDepartementInformatiqueAnayeesFrancisPatrickOthmane.model.entities.Cours"%>
...
<html>
    ...
    <jsp:include page="/entete.jsp"/>
     ...
     <td> <%=tnotes.getCours().getNom() %> </td>
      ...
      <td> <%=tnotes.getProfesseur().getNom() %> </td>
      <td> <%=tnotes.getDocument() %> </td>
      <td>
            <a href="">
     ...
     <td> <%=user.getCours().getNom() %> </td>
      <td> <%=user.getLien() %> </td>
      <td> <%=user.getProfesseur().getNom() %> </td>
