...
List<Etudiant> listeTuteurs;
List<Etudiant> listeEtudiantsDifficultes;
List<Etudiant> listeTousEtudiants;
List<Projet> listeProjets;
List<Professeur> listeProfesseurs;
List<Cours> listeCours;
List<NoteDeCours> listeNotesDeCours;
List<Utilisateur> listeMembresJury;
