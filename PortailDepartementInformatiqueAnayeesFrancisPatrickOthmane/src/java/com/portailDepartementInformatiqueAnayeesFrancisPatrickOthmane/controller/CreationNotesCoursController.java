...
public class CreationNotesCoursController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String id = request.getParameter("prenom");
        String lien = request.getParameter("password");
        String coursId = request.getParameter("photo");
        String nom = request.getParameter("role");
